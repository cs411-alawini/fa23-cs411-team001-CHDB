...
CREATE PROCEDURE GetOneNationsTopn(IN id INT,IN num INT)
BEGIN
...
--     OPEN nations_cursor;
	DROP TABLE IF EXISTS OneNationTopnTable;
	CREATE TABLE OneNationTopnTable (
		Nationid INT,
...
--         END IF;
		...
		videos_loop: LOOP
			...
			INSERT INTO OneNationTopnTable (Nationid, Video_id, Title, TotalViews)
			VALUES (id, cur_video_id, cur_title, cur_total_views);
